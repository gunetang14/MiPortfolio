...
<div class="about">
    ...
    <div class="about__enlaces contenedor">
        <a href="/portfolio" class="about__enlaces--boton">Proyectos</a>
        <a href="/skills" class="about__enlaces--boton">Habilidades</a>
    </div>

    <div class="coding contenedor">
        <p class="coding--efect">Eat</p>
        <p class="coding--efect">Sleep</p>
        <p class="coding--efect">Code</p>
        <p class="coding--efect">Repeat</p>
    </div>
</div>
